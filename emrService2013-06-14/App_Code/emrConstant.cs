...
namespace EmrConstant
{
    ...
    public struct ResourceName
    {
        ...
        public const string NoteTemplateDoc = "Template.notx";
        ...
        public const string Mytmp = "病历记录.notx";
    ...
    public struct StringGeneral
    {
        ...
        public const string WinTitle = "天津微软技术中心--电子病历书写平台 EMRW S2008 -- ";
        public const string Commited = "(已提交)";
        ...
        public const string PatientSign = "患者或家属：";
        public const string Big = "Big";
        public const string Small = "Small";
        public const string Yes = "Yes";
        public const string No = "No";
        public const string Exit = "退出";
        /* Type Value in EmrPattern */
    ...
    public struct IntGeneral
    {
        ...
        public const int TaskPaneWidth = 270;
    }
    ...
    public struct ElementNames
    {
        ...
        public const string cddm = "cddm";
        public const string cdmc = "cdmc";
        public const string ckdm = "ckdm";
    ...
    public struct AttributeNames
    {
        ...
        public const string OutRegistryDate = "OutRegistryDate";
        ...
        public const string DepartmentNameA = "DepartmentName";
